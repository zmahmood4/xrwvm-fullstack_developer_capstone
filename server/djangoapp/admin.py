...
# Inline for CarModel
class CarModelInline(admin.TabularInline):  # You can also use `StackedInline` instead of `TabularInline`
    model = CarModel
...
class CarModelAdmin(admin.ModelAdmin):
    list_display = ('name', 'car_make', 'type', 'year')  # Fields to display in list view
